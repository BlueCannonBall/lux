...
class StreamingWindow {
    ...
    startStreaming(ipAddress, password, viewOnly = false) {
        ...
        if (!viewOnly) {
            this.reliableChannel = this.conn.createDataChannel("reliable-input", { ordered: true });
            this.unreliableChannel = this.conn.createDataChannel("unreliable-input", { ordered: false, maxRetransmits: 0 });
            this.reliableChannel.onclose = this.unreliableChannel.onclose = () => {
